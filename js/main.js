...
(function ($) {
    ...
    var menu = {
        ...
        $('.btn-show-menu-mobile').off('click').on('click', function(e) {
            ...
            $('.menu-mobile').stop(true, true).slideToggle(300);
        ...
        $(document).on('click', function(e) {
            if (!$(e.target).closest('.menu-mobile, .btn-show-menu-mobile').length) {
        ...
        $(document).off('click', '.menu-mobile a').on('click', '.menu-mobile a', function(e) {
            var $this = $(this);
            
            // Special case for Services link
            ...
            else if ($this.hasClass('mega-menu-link') && $this.siblings('ul, ol').length) {
                e.preventDefault();
                $this.toggleClass('active').next('ul, ol').slideToggle(300);
            } 
            // If it's a regular link
                ...
                // Get the target URL and navigate
...
document.getElementById('contactForm').addEventListener('submit', function (e) {
    e.preventDefault();
    alert('Form submitted! (Implement your form handling logic here.)');
    this.reset();
});
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    // Get all menu items
    const menuItems = document.querySelectorAll('.mega-menu-item a');
    ...
    menuItems.forEach(item => {
        ...
        if (itemHref === '#' || !itemHref) return; // Skip items with # or empty href

        // If the current page matches the href, add active class
        if (currentPage === itemHref ||
            (currentPage === 'service.html' && itemHref === 'service.html')) {
